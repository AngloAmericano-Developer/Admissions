...
function denyRead(){
    $("#content").load("views/error.html?v=5.4",function(){
...
function logged_area(){
    ...
    $(".body_").load("views/body.html?v=5.4",function(){
        ...
        modulesMain();
        $("#modalView").load("views/modalObs.html?v=5.4");
        $("#modalLargeView").load("views/modalLarge.html?v=5.4");
        $(".item").click(function(){
