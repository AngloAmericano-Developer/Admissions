...
function denyRead(){
    $("#content").load("views/error.html?v=5.0",function(){
...
function logged_area(){
    ...
    $(".body_").load("views/body.html?v=5.0",function(){
        ...
        modulesMain();
        $("#modalView").load("views/modalObs.html?v=5.0");
        $("#modalLargeView").load("views/modalLarge.html?v=5.0");
        $(".item").click(function(){
