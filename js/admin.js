...
function denyRead(){
    $("#content").load("views/error.html?v=4.1",function(){
...
function logged_area(){
    ...
    $(".body_").load("views/body.html?v=4.1",function(){
        ...
        modulesMain();
        $("#modalView").load("views/modalObs.html?v=4.1");
        $("#modalLargeView").load("views/modalLarge.html?v=4.1");
        $(".item").click(function(){
